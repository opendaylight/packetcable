...
public class DOCSISRTPTrafficProfile extends PCMMBaseObject implements ITrafficProfile {
    ...
    protected byte[] getBytes() {
        ...
        int value = ((int)amrtrPacketSize<<16) | (int)maximumConcatenatedBurst;
        int zero = 0;
        int offset = 0;
  
        // Authorized Envelope
        System.arraycopy(ByteBuffer.allocate(4).putInt(requestTransmissionPolicy).array(), 0, data, (offset += 4), 4);
        System.arraycopy(ByteBuffer.allocate(4).putInt(maximumSustainedTrafficRate).array(), 0, data, (offset += 4), 4);
        System.arraycopy(ByteBuffer.allocate(4).putInt(maximumTrafficBurst).array(), 0, data, (offset += 4), 4);
        System.arraycopy(ByteBuffer.allocate(4).putInt(minimumReservedTrafficRate).array(), 0, data, (offset += 4), 4);
        System.arraycopy(ByteBuffer.allocate(4).putInt(value).array(), 0, data, (offset += 4), 4);
        System.arraycopy(ByteBuffer.allocate(4).putInt(nominalPollingInterval).array(), 0, data, (offset += 4), 4);
        System.arraycopy(ByteBuffer.allocate(4).putInt(toleratedPollJitter).array(), 0, data, (offset += 4), 4);
        //System.arraycopy(ByteBuffer.allocate(4).putInt(upstreamPeakTrafficRate).array(), 0, data, (offset += 4), 4);
        System.arraycopy(ByteBuffer.allocate(4).putInt(requiredAttributeMask).array(), 0, data, (offset += 4), 4);
        System.arraycopy(ByteBuffer.allocate(4).putInt(forbiddenAttributeMask).array(), 0, data, (offset += 4), 4);
        System.arraycopy(ByteBuffer.allocate(4).putInt(attributeAggregationRuleMask).array(), 0, data, (offset += 4), 4);
        //System.arraycopy(ByteBuffer.allocate(4).putInt(zero).array(), 0, data, (offset += 4), 4);
        //System.arraycopy(ByteBuffer.allocate(4).putInt(zero).array(), 0, data, (offset += 4), 4);
        //System.arraycopy(ByteBuffer.allocate(4).putInt(zero).array(), 0, data, (offset += 4), 4);
