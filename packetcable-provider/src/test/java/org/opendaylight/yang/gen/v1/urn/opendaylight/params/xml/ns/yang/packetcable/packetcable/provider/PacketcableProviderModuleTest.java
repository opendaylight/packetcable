...
public class PacketcableProviderModuleTest {
	...
	@Mock private OpendaylightPacketcableProvider provider;
	@InjectMocks private PacketcableProviderModule packetCableProviderModuleMock = mock(PacketcableProviderModule.class);

	@Before
	public void setUp() throws Exception {
		when(packetCableProviderModuleMock.createInstance()).thenReturn(provider);
	}
