...
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.AppContext;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.CcapContext;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.CcapPollConnectionInput;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.CcapPollConnectionOutput;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.CcapPollConnectionOutputBuilder;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.CcapSetConnectionInput;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.CcapSetConnectionOutput;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.CcapSetConnectionOutputBuilder;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.Ccaps;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.PacketcableService;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.Qos;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.QosPollGatesInput;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.QosPollGatesOutput;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.QosPollGatesOutputBuilder;
...
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.ccaps.CcapBuilder;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.pcmm.qos.gate.spec.GateSpec;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.pcmm.qos.gate.spec.GateSpecBuilder;
...
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.pcmm.qos.gates.apps.AppBuilder;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.pcmm.qos.gates.apps.AppKey;
...
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.pcmm.qos.gates.apps.app.subscribers.SubscriberKey;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.pcmm.qos.gates.apps.app.subscribers.subscriber.Gates;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.pcmm.qos.gates.apps.app.subscribers.subscriber.GatesBuilder;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.pcmm.qos.gates.apps.app.subscribers.subscriber.gates.Gate;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.pcmm.qos.gates.apps.app.subscribers.subscriber.gates.GateBuilder;
import org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.pcmm.qos.gates.apps.app.subscribers.subscriber.gates.GateKey;
...
public class PacketcableProvider implements BindingAwareProvider, AutoCloseable, PacketcableService {
    ...
    private <T extends DataObject> void saveErrors(@Nonnull Map<DataTreeModification<T>, ValidationException> exceptionMap) {

        final WriteTransaction writeTransaction = dataBroker.newWriteOnlyTransaction();

        for (DataTreeModification<T> change : exceptionMap.keySet()) {
...
*/
        ...
        @Override
        protected void handleInvalidData(Map<DataTreeModification<Ccap>, ValidationException> exceptionMap){
    ...
    private class QosDataTreeChangeListener extends AbstractDataTreeChangeListener<Gate> {
        ...
        protected void handleCreatedData(final DataTreeModification<Gate> change) {
            ...
            /*try {
                qosDataValidator.validate(gateIID, newGate, Validator.Extent.NODE_AND_SUBTREE);
            }
        ...
        @Override
        protected void handleInvalidData(Map<DataTreeModification<Gate>, ValidationException> exceptionMap){
            if (!exceptionMap.isEmpty()) {
                // bad data write errors to operational datastore
                saveErrors(exceptionMap);
            }
        }
    ...
    public Future<RpcResult<CcapSetConnectionOutput>> ccapSetConnection(CcapSetConnectionInput input) {
        ...
        org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.ccap.set.connection.output.ccap.ConnectionBuilder
                connectionRpcOutput =
                new org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.ccap.set.connection.output.ccap.ConnectionBuilder()
                        .setConnected(effectiveIsConnected)
                        .setError(outputError)
                        .setTimestamp(connectionDateAndTime);

        org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.ccap.set.connection.output.CcapBuilder ccapRpcOutput =
                new org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.ccap.set.connection.output.CcapBuilder().setCcapId(
    ...
    public Future<RpcResult<CcapPollConnectionOutput>> ccapPollConnection(CcapPollConnectionInput input) {
        ...
        org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.ccap.poll.connection.output.ccap.ConnectionBuilder
                connectionRpcOutput =
                new org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.ccap.poll.connection.output.ccap.ConnectionBuilder();
        ...
        org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.ccap.poll.connection.output.CcapBuilder ccapRpcOutput =
                new org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.ccap.poll.connection.output.CcapBuilder().setCcapId(
                        ccapId).setConnection(connectionRpcOutput.build());
    ...
    public Future<RpcResult<QosPollGatesOutput>> qosPollGates(QosPollGatesInput input) {
        ...
        org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.qos.poll.gates.output.GateBuilder gateOutputBuilder =
                new org.opendaylight.yang.gen.v1.urn.packetcable.rev161107.qos.poll.gates.output.GateBuilder();
